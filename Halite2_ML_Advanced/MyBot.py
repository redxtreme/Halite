...
# Silence outputs of tensorflow as to not interfere with Halite
...
# Set the percentage so you can train two AIs at the same time
# from keras.backend.tensorflow_backend import start_session
